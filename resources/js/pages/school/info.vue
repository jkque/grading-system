    ...
    <b-row>
      <b-col sm="6" md="12">
        ...
        <form @submit.prevent="update" @keydown="form.onKeydown($event)">
            ...
            <!-- Passing Rate -->
            <div class="form-group row">
                <label class="col-md-3 col-form-label text-md-right">Passing Rate</label>
                <div class="col-md-7">
                <input v-model="form.passing_rate" :class="{ 'is-invalid': form.errors.has('passing_rate') }" class="form-control" type="text" name="passing_rate">
                <has-error :form="form" field="passing_rate"/>
                </div>
            </div>
